...
type ConfigNode = XYNode<NodeData>
    ...
    switch (node.type) {
        ...
        return (
          <div className="space-y-4">
            <div className="space-y-2">
              <Label htmlFor="condition">{t("config.conditional.condition")}</Label>
              <Textarea
                id="condition"
              ...
              <p className="text-xs text-muted-foreground">
                {t("config.conditional.conditionHint")}
              </p>
            </div>
          </div>
        )
      ...
      case "httpRequest":
        return (
          <div className="space-y-4">
            <div className="space-y-2">
              <Label htmlFor="url">{t("config.httpRequest.url")}</Label>
              <Input
                id="url"
                value={node.data.url || ""}
              ...
              />
              <p className="text-xs text-muted-foreground">
                {t("config.httpRequest.urlHint")}
              </p>
            </div>

            <div className="space-y-2">
              <Label htmlFor="method">{t("config.httpRequest.method")}</Label>
  ...
  return (
    <aside className="absolute right-0 top-0 z-10 h-full w-full border-l border-border bg-card md:relative md:w-80">
      <div className="flex items-center justify-between border-b border-border p-4">
        <h2 className="text-sm font-semibold text-foreground">{t("config.title")}</h2>
